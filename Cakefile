...
file = 'PHPGuzzleCodeGenerator.coffee'
identifier = 'com.luckymarmot.PawExtensions.PHPGuzzleCodeGenerator'
...
build_copy = () ->
    ...
    fs.writeFileSync "#{ build_dir }/php.mustache", fs.readFileSync("./php.mustache")
